      ...
      new Chart(document.getElementById('chart-soc'), {
        ...
        data: {
          datasets: [
            {
              label: 'Combined',
              data: toChartData(d.combined_soc),
              borderColor: '#22c55e',
      ...
      new Chart(document.getElementById('chart-power'), {
        ...
        data: {
          datasets: [
            {
              label: 'PV Production',
              data: toChartData(d.pv_production),
              borderColor: '#eab308',
            ...
            },
            {
              ...
              data: toChartData(d.battery_to_home),
              borderColor: '#22c55e',
            ...
            {
              label: 'Grid Import',
              data: toChartData(d.grid_import),
              borderColor: '#ef4444',
