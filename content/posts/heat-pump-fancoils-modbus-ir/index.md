...
The Therma V exposes a Modbus TCP interface on port 8899. Home Assistant's built-in [Modbus integration](https://www.home-assistant.io/integrations/modbus/) connects directly — no cloud, no gateway, pure local control.
